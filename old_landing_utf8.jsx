...
// v7 ΓÇö "The Special Report" final form
...
// ΓöÇΓöÇ Paper-grain SVG (encoded as data URI, under 1KB) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Color system ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const C = {
  bg:        "#0a0a0c",
  bgSoft:    "#131316",
  bgDeep:    "#050506",
...
// ΓöÇΓöÇ Community-validated pathway palette ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const PATH_COLORS = {
  intact:      "#5b93c7",
  circumcised: "#d94f4f",
  restoring:   "#e8c868",
...
// ΓöÇΓöÇ Gradient grammar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Consensus detection ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Paper styles (with grain) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const PAPER_BG = `url("${GRAIN_SVG}"), linear-gradient(180deg, ${C.paper} 0%, ${C.paperWarm} 100%)`;

// ΓöÇΓöÇ IntersectionObserver hooks ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
function useReveal(options = {}) {
  ...
  useEffect(() => {
    ...
    const attach = () => {
      el = ref.current;
      if (!el) return false;
      // Check if already in viewport NOW ΓÇö for elements that mount already visible
    ...
    if (result === false) {
      ...
      const raf = requestAnimationFrame(() => {
        const r2 = attach();
        if (r2 === false) setVisible(true); // Give up gracefully ΓÇö just show it
      });
...
// Animated tween 0 ΓåÆ 1 over duration ms once visible
...
function CircumSurveySeal({ size = 44, ringColor = C.red, starColor = C.gold }) {
  ...
  // Stylized small-size mark ΓÇö big star, red disc, text arc only if it fits
  const r = size / 2;
  const cx = r, cy = r;
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ color: C.red, fontSize: "1.05em" }}>Γÿà</span>
          {title}
          {cardLabel && (
            <span style={{
              marginLeft: "0.5rem",
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// THE CINEMATIC HERO ΓÇö full-viewport data-driven entry
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É

// Data poetry ΓÇö devastating numbers that cycle
const HERO_FACTS = [
  {
    big:   "96%",
    line1: "prioritize the child's right",
    line2: "to bodily autonomy.",
    context: "Across every pathway ΓÇö intact, circumcised, restoring, observer.",
    color: C.blue,
  },
  {
    big:   "80%",
...
function CinematicHero() {
  ...
  return (
    <div style={{
      ...
      {/* Top eyebrow ΓÇö publication masthead */}
      <div style={{
        position: "absolute",
        top: "1.5rem",
        left: "50%",
        ...
        <span style={{ color: C.red, fontSize: "1rem" }}>Γÿà</span>
        <span style={{
          fontFamily: "'Barlow Condensed', sans-serif",
          fontWeight: 700,
          fontSize: TYPE.cardLabel,
      ...
      {/* Publication title ΓÇö "The Accidental Intactivist's Inquiry" in big */}
      <Reveal delay={150}>
        <div style={{
          textAlign: "center",
          marginBottom: "1.5rem",
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// EDITOR'S LETTER ΓÇö Tone's first-person introduction as card #1
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
    ...
    >
      <div style={{ padding: "2.5rem 2.5rem 2rem", position: "relative" }}>
        ...
        <div style={{
          ...
          <p style={{ marginBottom: "1rem" }}>
            By a conscious choice of my parents in the 1970s, I grew up intact ΓÇö an outlier
            ...
            my friends, my partners, and men in the media had undergone ΓÇö something my
          ...
          <p style={{ marginBottom: "1rem" }}>
            ...
            shouldn't be done ΓÇö but I almost never hear adults talking honestly about their
          ...
          <p style={{ marginBottom: "1rem" }}>
            ...
            ΓÇö no other question in this survey produces a consensus that strong. It is the
          ...
          <p style={{ marginBottom: "1.5rem" }}>
            ...
            and cons. Nearly half ΓÇö 47.6% ΓÇö describe it as "routine or automatic." That is
          ...
          <p style={{ marginBottom: "1rem" }}>
            ...
            said when finally asked</em> ΓÇö and to bring these essential stories into
            the light.
          </p>
        </div>

        {/* Signature block ΓÇö Tone's real contact info */}
        <div style={{
          display: "flex",
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// SECTION TITLE CARD ΓÇö magazine-chapter divider
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ color: C.red, marginRight: "0.5rem" }}>Γÿà</span>
        Chapter {chapter} of {totalChapters}
        <span style={{ color: C.red, marginLeft: "0.5rem" }}>Γÿà</span>
      </div>
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// DEVASTATING NUMBER ΓÇö full-bleed interstitial between sections
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// PULL QUOTE SEPARATOR ΓÇö respondent voice between sections
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
  ...
  return (
    ...
    >
      <div style={{
        ...
        <span style={{ color: C.red, fontSize: "0.7em", marginRight: "0.4rem", verticalAlign: "top" }}>Γÿà</span>
        {quote}
        <span style={{ color: C.red, fontSize: "0.7em", marginLeft: "0.4rem", verticalAlign: "top" }}>Γÿà</span>
      </div>
      <div style={{
        fontFamily: "'Barlow Condensed', sans-serif",
        fontWeight: 700,
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// NARRATIVE PROGRESS RAIL ΓÇö sticky right-side chapter indicator
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// ACTIVE SECTION TRACKER ΓÇö Intersection Observer for rail
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// ANIMATED STACKED BAR ΓÇö 100% stacks per pathway, grows from baseline
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
...
function StackedBar({ q, width = 400, height = 280 }) {
  ...
  return (
    <svg ref={ref} width={width} height={height} style={{ display: "block", maxWidth: "100%", height: "auto" }}>
      {/* Axis title ΓÇö makes clear these stacks are BELIEFS BY pathway */}
      ...
      {stacks.map((stack, si) => {
        ...
        return (
          <g key={stack.pathway}>
            ...
            {/* Pathway label group ΓÇö emoji + name + n, more visually grounded */}
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// ANIMATED GROUPED BAR ΓÇö clusters of pathway bars per metric
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
        ...
        return (
          <g key={metric.id}>
            {pathways.map((p, pi) => {
              ...
              // Staggered reveal ΓÇö each bar delays by group index + bar index
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// PLEASURE GAP HERO ΓÇö featured grouped bar at top of that section
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
...
function PleasureGapHero() {
  ...
  const questions = sexQs.map(q => ({
    id: q.id,
    label: q.q.replace(/\s*\(1ΓÇô5 scale\)\s*$/, ""),
    data: q.data,
  }));
  ...
  return (
    <BureauCard
      title="The Pleasure Gap ΓÇö Direct Comparison"
    ...
    >
      <div style={{ padding: "1.75rem 1.75rem 1rem" }}>
        <FormField
          ...
          body="Each cluster shows the mean rating (1ΓÇô5 scale) for one dimension. Bars for Circumcised, Restoring, and Intact respondents sit side-by-side so the Pleasure Gap is visible at a glance: the blue Intact bar consistently sits above the other two across every dimension."
        />
        ...
        {biggestGap && (
          <StatCallout
            ...
            text={<>The largest gap is <strong>{biggestGap.label}</strong>: Intact respondents rate it <strong>{biggestGap.intact.toFixed(2)}</strong>, Circumcised respondents <strong>{biggestGap.circumcised.toFixed(2)}</strong> ΓÇö a {Math.abs(biggestGap.delta / biggestGap.intact * 100).toFixed(0)}% gap on a 5-point scale.</>}
            color={C.red}
          />
        )}
        ...
        <ArrowNotes notes={[
          ...
          "Circumcised and Restoring Pathways track closely ΓÇö restoration recovers partial function",
...
function ArrowNotes({ notes }) {
  ...
  return (
    <div style={{
      ...
      {notes.map((note, i) => (
        <div key={i}>
          <span style={{ color: C.gold, fontWeight: 700 }}>ΓåÆ</span> {note}
        </div>
      ))}
    </div>
  );
...
function LanguageNote({ children }) {
  return (
    <div style={{
      ...
      <strong style={{ color: C.gold, fontWeight: 700, fontStyle: "normal", fontFamily: "'Barlow Condensed', sans-serif", textTransform: "uppercase", fontSize: "0.7rem", letterSpacing: "0.1em" }}>Γÿà Language Note ┬╖ </strong>{" "}
      {children}
    </div>
  );
}
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// QUOTE GALLERY ΓÇö voices from the survey
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ color: C.red }}>Γÿà</span> Voices from the Survey
      </div>
      <div style={{
        display: "grid",
            ...
            <Reveal key={`${pathway}-${i}`} delay={i * 80}>
              <div style={{
                ...
                <div style={{
                  ...
                  letterSpacing: "0.1em",
                  color,
                }}>ΓÇö {meta.short} Pathway ┬╖ {qt.context}</div>
              </div>
            </Reveal>
          ));
        })}
      ...
      <div style={{
        ...
        color: C.paperGhost,
        marginTop: "0.6rem",
      }}>Γÿà Anonymous quotes from open-ended responses. All identifying details removed.</div>
    </div>
  );
}

// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// CARD SUMMARIES ΓÇö editorial callouts keyed to question id
...
const CARD_SUMMARIES = {
  // ΓöÇΓöÇ Sexual Experience (six avg cards) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  "intensity": {
    headline: "Intact respondents rate orgasm intensity 25% higher.",
    body: "On a 1ΓÇô5 scale, intact men average 3.73 vs 2.99 for circumcised men ΓÇö a gap of three-quarters of a full point. Restoring respondents land at 2.93, close to where they started, suggesting intensity recovers more slowly than other dimensions.",
    frame: "gap",
  },
  "duration_r": {
    headline: "Orgasm duration sees the second-largest gap.",
    body: "Intact respondents average 3.80; circumcised 2.81. A full point of separation on a 5-point scale is large in survey terms ΓÇö comparable to the gap between 'satisfied' and 'very dissatisfied' on an attitudinal scale. Restoring at 2.65 is actually below the circumcised average, which some restorers attribute to keratinization recovery being incomplete.",
    frame: "gap",
  },
  "ease": {
    headline: "The smallest Pleasure Gap ΓÇö but still present.",
    body: "Ease of reaching orgasm shows the narrowest spread of the six dimensions (3.43 vs 2.91, a 15% gap). This matters because 'ease' is the metric most confounded by arousal, partner dynamics, and psychological factors ΓÇö the fact that it still shows a measurable gap rather than none at all is notable.",
    frame: "gap",
  },
  "light": {
    headline: "Intact respondents report 41% more sensitivity to light touch.",
    body: "3.67 vs 2.60 ΓÇö the third-largest Pleasure Gap and the one most directly tied to the anatomy. Light-touch receptors concentrated in the foreskin's ridged band are removed by circumcision. Restoring respondents report 2.67, a modest recovery that tracks with the documented de-keratinization process.",
    frame: "gap",
  },
  "mobile": {
    headline: "The largest gap in the entire Sexual Experience module.",
    body: "Pleasure from gliding / mobile skin: 3.88 intact, 2.49 circumcised ΓÇö a 36% gap, the widest measured. This is the mechanical function most completely lost in circumcision: the foreskin's ability to slide over the glans creating frictionless sensation. Restorers at 3.00 are the clearest demonstration that even partial mechanical restoration moves the needle.",
    frame: "gap",
  },
  "variety": {
    headline: "Intact respondents report 46% more variety of sensation.",
    body: "3.78 vs 2.58. 'Variety' here means the range of pleasurable sensations reported ΓÇö from subtle to intense, from localized to full-body. A narrower dynamic range is consistent with keratinization, nerve remodeling, and the loss of the foreskin's distinct sensation-class. Restorers sit at 2.65, suggesting variety is harder to recover than raw sensitivity.",
    frame: "gap",
  },
};
...
function QCard({ q, defaultPathway, forceCardLabel }) {
  ...
  if (isAvg && q.data.intact && q.data.circumcised) {
    ...
    notes.push(`╬ö ${delta.toFixed(2)} (${pct}% ${delta > 0 ? "lower" : "higher"} in circumcised vs intact)`);
  }
          ...
          <div style={{ display: "flex", gap: "1.5rem", alignItems: "flex-start", flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: 220 }}>
              {isAvg ? (
                ...
                <FormField
                  label={`Response Distribution ΓÇö ${currentMeta.emoji} ${currentMeta.label} (n = ${currentMeta.n})`}
                  last
                >
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// MIRROR CARD ΓÇö the devastating juxtapositions
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
...
function MirrorCard({ pair }) {
  ...
  return (
    <BureauCard
      ...
      refText={`${leftMeta.short.toUpperCase()} Γçö ${rightMeta.short.toUpperCase()} ┬╖ PARALLEL QUESTION PAIR`}
      stamp="Mirror"
      stampColor={C.gold}
      gradient={gradient}
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// SIX PATHWAYS ΓÇö the survey's full architecture
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É

// Pathway metadata for the intro card and the voices section
// This is a superset of PATHWAY in data.js ΓÇö adds trans and intersex
...
const PATHWAY_META_EXT = [
  {
    ...
    featured_in: "chapters 1ΓÇô7, plus demographics & voices",
  },
  {
  ...
  },
  {
    ...
    color: "#e8c868",
    description: "Men actively restoring ΓÇö or who have completed restoring ΓÇö their foreskin.",
  ...
  },
  {
    ...
    color: "#a0a0a0",
    description: "Partners, parents of AMAB children, doctors, therapists, intactivists ΓÇö witnesses without a personal anatomical stake.",
      ...
      >
        <div style={{ padding: "2rem 2.25rem 2.25rem" }}>
          <p style={{
            ...
            The survey isn't one questionnaire with a single audience ΓÇö it's{" "}
            ...
            {PATHWAY_META_EXT.map(p => (
              ...
              >
                ...
                <div style={{
                  ...
                  {p.dormant ? "Γÿà We're listening ΓÇö if this is you, your survey is waiting" : `Featured ${p.featured_in}`}
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{
            ...
            conversation is part of a larger coalition ΓÇö genital autonomy is a
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// VOICES SECTION ΓÇö parallel pathway columns of curated quotes
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
    ...
    <div style={{
      ...
      {dormant ? (
        <div style={{
          ...
          No respondents yet. This pathway exists in the survey ΓÇö{" "}
          <a
            href="https://forms.gle/FQ8o9g7j1yU3Cw7n7"
            target="_blank"
            rel="noreferrer"
      ...
      >
        <div style={{ padding: "1.75rem 2rem 1.75rem" }}>
          <p style={{
            ...
            thousands of words of lived experience ΓÇö sometimes tender,
          ...
          <p style={{
            ...
            ΓÇö including responses I chose not to surface and why ΓÇö is available
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// DEMOGRAPHICS EXPLORER ΓÇö "who circs and who doesn't?"
...
function DemographicsExplorerCard() {
  ...
  // Find max bar width for proportional rendering ΓÇö use count of largest category
      ...
      >
        <div style={{ padding: "2rem 2.25rem 2.25rem" }}>
          ...
          <p style={{
            ...
            parenting decisions ΓÇö politics, education, religion, generation, country ΓÇö and a portrait
          ...
          <div style={{
            ...
            {[
              ...
              { id: "intact",  label: "% Intact (highΓåÆlow)" },
          ...
          <div style={{ marginTop: "0.75rem", marginBottom: "1.5rem" }}>
            {categories.map((cat) => {
              ...
              // Heuristic: segment_px Γëê container_px * (relativeWidth/100) * (pct/100)
              // We want at least ~30px for a label to fit comfortably.
              // Assume container is ~720px at worst case ΓåÆ threshold = 30 / (720 * relativeWidth/100) * 100
              ...
              return (
                <div key={cat.category} style={{ marginBottom: "0.95rem" }}>
                  ...
                  {/* Stacked bar ΓÇö intact (blue) vs circumcised (red) */}
                  <div style={{
                    position: "relative",
                    height: 24,
                    width: `${relativeWidth}%`,
          ...
          <div style={{
            ...
            <div style={{
              ...
              intact minority of this sample. Within their cohort ΓÇö U.S.-born Boomers, middle-class,
              college-educated ΓÇö that choice was especially rare. What distinguished them? A
            ...
            <div style={{
              ...
              marginTop: "0.85rem",
              fontWeight: 700,
            }}>ΓÇö Tone Pettit, Lead Researcher</div>
          </div>
...
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
// ACT ON THIS ΓÇö four cards that convert "so what?" into action
// ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É
  ...
  return (
    <div id="section-urgent-plaintiff" style={{ scrollMarginTop: "4rem" }}>
      <BureauCard
        ...
        cardLabel="Γÿà URGENT CALL TO ACTION"
        shimmer={false}
      >
        <div style={{ padding: "2rem 2.25rem 2.25rem" }}>
          {/* URGENT badge */}
          ...
          <p style={{
            ...
            If you are this person ΓÇö or if you know a family who might be ΓÇö your story could be
          ...
          <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
            ...
            >Γ£ë Reach Out Confidentially</a>
            <a
              href="https://forms.gle/FQ8o9g7j1yU3Cw7n7"
              target="_blank"
              rel="noreferrer"
...
function StrategicPartnersCard() {
  const partners = [
    ...
    },
    {
      ...
      color: C.red,
      blurb: "Legal advocacy led by attorney Eric Clopper. Preparing a landmark Washington State Equal Protection lawsuit ΓÇö our dataset is an active tool in their strategic litigation.",
    },
    {
      name: "GALDEF",
        ...
        <div style={{ padding: "2rem 2.25rem 2.25rem" }}>
          ...
          <div style={{
            ...
            {partners.map(p => (
              ...
              >
                {/* Logo container ΓÇö white background so logos have room to breathe */}
                <div style={{
                  background: "#fff",
                  padding: "1.25rem",
                  display: "flex",
  ...
  const resources = [
    {
      ...
      sub: "125 pages ┬╖ PDF",
      blurb: "The foundational document behind this research. Personal insight, scientific inquiry, and cultural critique ΓÇö the history, ethics, anatomy, and emotional truth.",
    ...
    },
    {
      ...
      sub: "Full-page posters, 2├ù2 handout cards, QR image",
      ...
      >
        <div style={{ padding: "2rem 2.25rem 2.25rem" }}>
          <p style={{
            ...
            are the concrete paths ΓÇö from five minutes to long-term:
          </p>
      ...
      >
        <div style={{ padding: "1.75rem 1.75rem 1.5rem" }}>
          <FormField
            ...
            body="Respondents who have observed the impact of circumcision in others' lives. Their independent witness perspective ΓÇö without a personal anatomical stake ΓÇö makes their answers striking. The Observer Pathway includes spouses, partners, parents of AMAB children, doctors, researchers, therapists, and intactivists."
          />
...
function Sidebar({ open, onClose, onSelect, activeId }) {
  ...
  const sections = [
    ...
    { cat: "The Six Pathways", color: C.gold, items: [
      ...
      { id: "section-voices",       label: "In Their Own Words ΓÇö The Record", isSection: true },
    ]},
    ...
    { cat: "Γÿà Act on This",    color: C.red,    items: [
      { id: "section-demographics",     label: "Demographics Explorer", isSection: true },
      { id: "section-urgent-plaintiff", label: "Γÿà Urgent: WA Plaintiff Search", isSection: true },
    ...
    <>
      <div style={{
            ...
            return (
              <div key={sec.cat} style={{ marginBottom: "0.25rem" }}>
                <button onClick={() => toggle(sec.cat)} style={{
                  ...
                  <span style={{ fontSize: "0.6rem", transition: "transform 0.15s", transform: isOpen ? "rotate(180deg)" : "" }}>Γû╛</span>
                </button>
        ...
        <div style={{
          ...
          Γÿà {ALL_QUESTIONS.length + MIRROR_PAIRS.length} items ┬╖ {META.totalRespondents} respondents
        </div>
      </div>
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ color: C.red }}>Γÿà</span> Methodology & Ethics
          </div>
          <button onClick={onClose} style={{ background: "none", border: "none", color: C.pageMuted, cursor: "pointer", fontSize: "1.1rem" }}>Γ£ò</button>
        </div>
        ...
        <div style={{ padding: "2rem 1.75rem" }}>
          ...
          <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: "0.85rem", color: C.paperSubtle, lineHeight: 1.7 }}>
            ...
            <Link to="/about" style={{
              ...
              textTransform: "uppercase",
              letterSpacing: "0.08em",
            }}>Read Full Methodology ΓåÆ</Link>
          </div>
        </div>
      </div>
    </div>
...
function getNarrativeSections() {
  return [
    ...
    { id: "section-urgent-plaintiff", title: "Γÿà Urgent Call" },
...
const SECTION_INTERSTITIALS = {
  "pleasure_gap": {
    ...
    context: "Intact respondents rate it 3.88, circumcised respondents 2.49 ΓÇö across every dimension of sexual experience, intact leads.",
    color: "#d94f4f",
  },
  "resentment": {
    big: "0%",
  ...
  "autonomy": {
    ...
    context: "A near-universal consensus across all four pathways ΓÇö the rare finding where every voice agrees.",
    color: "#5b93c7",
  },
};
...
const PULL_QUOTES = [
  ...
  {
    quote: "Only as a teen or young adult did I feel self-conscious ΓÇö due to stigma from movies and pop culture.",
...
// ΓöÇΓöÇ Respondent count ΓåÆ readable prose ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export default function LandingPage() {
  ...
  // ΓöÇΓöÇ Live count: fetch from /api/count on mount, fall back silently ΓöÇΓöÇ
  ...
  // numbers stay. No loading spinner ΓÇö the site renders immediately with
  ...
  useEffect(() => {
    ...
    fetch("/api/count", { signal: ctrl.signal })
      ...
      .then(data => {
        ...
        // Mutate META in place ΓÇö safe because this is our own import
      ...
      .catch(() => {
        // Silent fallback ΓÇö static numbers already rendered
        clearTimeout(timeoutId);
      });
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <button onClick={() => setSidebarOpen(true)} style={{
          ...
          <span style={{ color: C.red }}>Γÿà</span> Navigate
        </button>
        ...
        <div style={{ display: "flex", gap: "0.3rem", flexWrap: "wrap", alignItems: "center" }}>
          ...
          {/* Visual divider ΓÇö these jump to sections within the curated view */}
          <span style={{
            width: 1, height: 16,
          ...
          {/* Section jump pills ΓÇö only visible/relevant in curated view */}
          {[
            { id: "section-voices",       l: "Voices",       icon: "Γ£Ä" },
            { id: "section-demographics", l: "Demographics", icon: "Γùê" },
          ].map(s => (
      ...
      {/* Cinematic Hero ΓÇö only in curated mode, no activeId */}
      ...
      <div style={{ maxWidth: 940, margin: "0 auto", padding: "2rem 1.5rem 3rem" }}>
        ...
        {view === "curated" && !activeId && (
          <>
            ...
            {/* ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É SIX PATHWAYS ΓÇö survey architecture, after the letter ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É */}
            <SixPathwaysCard />
            ...
            {/* ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É VOICES ΓÇö the narrative record, all six pathways ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É */}
            <VoicesSection />

            {/* ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É DEMOGRAPHICS EXPLORER ΓÇö the outlier-parents question ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É */}
            <DemographicsExplorerCard />

            {/* ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É ACT ON THIS ΓÇö from "so what?" to "so this" ├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É├óΓÇó┬É */}
            <UrgentPlaintiffCard />
      ...
      <div style={{ borderTop: `1px solid ${C.pageGhost}`, padding: "4rem 1.5rem", textAlign: "center" }}>
        ...
        <p style={{
          ...
          margin: "0 auto 2rem",
          lineHeight: 1.6,
        }}>Every perspective strengthens this dataset. 30ΓÇô90 minutes, fully anonymous, every question optional.</p>
        <a href="https://forms.gle/FQ8o9g7j1yU3Cw7n7" target="_blank" rel="noreferrer" style={{
          display: "inline-block",
      ...
      <footer style={{
        ...
        <span style={{ fontSize: "0.72rem", color: C.red, fontWeight: 600, letterSpacing: "0.02em" }}>
          Γÿà WA plaintiff search (Equal Protection lawsuit):{" "}
