...
function ModeToggle({ mode, setMode }) {
  const options = [
    { id: "cohort", label: "By Cohort", icon: "Users" },
    { id: "generation", label: "By Generation", icon: "Clock" },
  ];
  return (
    <div style={{
      display: "inline-flex",
        ...
        return (
          <button
            ...
            style={{
              ...
              background: isActive
                ? "linear-gradient(135deg, rgba(212,160,48,0.15) 0%, rgba(212,160,48,0.05) 100%)"
                : "transparent",
              border: "none",
              borderRight: opt.id !== "generation" ? `1px solid ${C.ghost}` : "none",
          ...
          >
            {IconComp && <IconComp size={14} color={isActive ? C.goldBright : C.muted} />}
            {opt.label}
          </button>
        );
      })}
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.textBright, fontFamily: FONT.body, paddingBottom: "6rem" }}>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "1.5rem 2rem 4rem" }}>
        {/* ── HEADER ─────────────────────────────────────────────── */}
        <div style={{
          background: `linear-gradient(135deg, rgba(20, 184, 166, 0.08) 0%, rgba(245, 158, 11, 0.05) 100%)`,
          ...
          <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 4, background: "linear-gradient(90deg, #14b8a6, #f59e0b)" }} />
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "1rem" }}>
            <div>
              ...
              <p style={{ margin: 0, fontSize: "1.05rem", lineHeight: 1.5, color: C.textBright, maxWidth: 700 }}>
                How do societal norms, stereotypes, and media influence our understanding of the male body? Explore how attitudes shift across cohorts and across generations — from the Silent Generation through Gen Z.
              </p>
            </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "4rem" }}>
              ...
              <div style={{
                ...
                <div style={{ padding: "2rem" }}>
                  {mode === "generation" ? (
                    ...
                    <CohortAssocCard questionId={activeAssoc} questionsMap={questionsMap} />
                  )}
                </div>
              </div>
            </section>

            {/* ── Section: Belief Pathways (Sankey) — cohort mode only */}
            {mode === "cohort" && (
                  ...
                  <div style={{
                    ...
                    <div style={{ padding: "2rem" }}>
                      {mode === "generation" ? (
                        ...
                        <CohortAssocCard questionId={item.id} questionsMap={questionsMap} />
                      )}
                    </div>
                  </div>
                </section>
            ...
            {/* ── Section: Qualitative Narratives — cohort mode only */}
            {mode === "cohort" && (
              <section>
                <h2 style={{
                  fontFamily: FONT.condensed,
